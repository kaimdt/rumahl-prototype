# ═══════════════════════════════════════════════════════════════════
# connect-ssh.ps1 – SSH into the rumahl dev VM
# ═══════════════════════════════════════════════════════════════════
...
$SSH_KEY = Join-Path $SCRIPT_DIR ".cache\rumahl-dev-key"
...
Write-Host "Connecting to rumahl Dev VM..." -ForegroundColor Cyan
