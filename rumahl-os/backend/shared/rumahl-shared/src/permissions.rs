...
pub enum Permission {
    ...
    // GitHub integration permissions via rumahl Assist
    GitHubRead,
    GitHubWrite,
    ...
    /// Provide AI tools (functions) that rumahl Assist / pi.dev agents can call
    AssistToolProvide,
...
impl Permission {
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            Permission::FileShareRead => "Lesen von geteilten Dateien (rumahl-share)",
            Permission::FileShareWrite => "Hochladen von Dateien (rumahl-share)",
            Permission::FileShareDelete => "Löschen von Dateien (rumahl-share)",
            ...
            Permission::AssistContextRead => "rumahl Assist Kontext lesen",
            Permission::AssistEventsSubscribe => "rumahl Assist Ereignisse abonnieren",
            Permission::AssistChat => "Nachrichten an rumahl Assist senden",
            Permission::AssistTaskCreate => "rumahl Assist Agent-Aufgaben erstellen",
            Permission::AssistTaskManage => "rumahl Assist Agent-Aufgaben verwalten",
            Permission::AssistToolExecute => "rumahl Assist Tools ausführen",
            Permission::GitHubRead => "GitHub-Daten über rumahl Assist lesen",
            Permission::GitHubWrite => "GitHub-Daten über rumahl Assist schreiben",
            Permission::GitHubPullRequestRead => "GitHub Pull Requests über rumahl Assist lesen",
            ...
            Permission::AssistToolProvide => {
                "KI-Tools bereitstellen, die rumahl Assist / pi.dev-Agenten aufrufen können"
            }
