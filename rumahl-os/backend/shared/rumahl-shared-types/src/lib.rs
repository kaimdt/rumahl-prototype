//! Stable foundational types used across the rumahl ecosystem.
...
/// A generic event broadcast within the rumahl system.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RumahlEvent {
...
/// Health status reported by any rumahl program.
#[derive(Debug, Clone, Serialize, Deserialize)]
