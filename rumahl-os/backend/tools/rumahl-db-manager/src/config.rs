        ...
        for service in &[
            ...
            services.insert(
                ...
                ServiceConfig {
                    ...
                    allow_ddl: service == &"rumahl-home" || service == &"rumahl-core", // Only main services do migrations
                },
            );
        }
...
impl DbConfig {
    ...
    pub fn get_database_name(&self, service: &str) -> String {
        self.services
            ...
            .unwrap_or_else(|| format!("rumahl_{}", service.trim_start_matches("rumahl-")))
    }
