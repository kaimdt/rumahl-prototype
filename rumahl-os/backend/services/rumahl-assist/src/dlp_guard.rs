...
lazy_static::lazy_static! {
    ...
    static ref SENSITIVE_PATTERNS: Vec<(Regex, &'static str, Severity)> = vec![
        ...
        // rumahl-specific: AI system token (rumahl_ait_ prefix)
        (Regex::new(r"rumahl_ait_[a-zA-Z0-9]{32,}").unwrap(), "ORA AI Token", Severity::Critical),
...
impl AiTokenManager {
    ...
    pub fn generate_token(&self, label: &str) -> Result<String, String> {
        ...
        let token_value = format!("rumahl_ait_{}", hex::encode(&random_bytes));
