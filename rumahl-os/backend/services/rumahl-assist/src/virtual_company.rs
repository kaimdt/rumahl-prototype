...
impl CompanyRole {
    ...
    pub fn system_prompt(&self) -> &str {
        match self {
            Self::CEO => "You are the CEO of ORA Virtual Company. Your role: strategic planning, task prioritization, resource allocation. Coordinate all other roles. Make executive decisions. Report directly to the user.",
