...
//!
//! Architektur:
//! - Genau **EIN** Docker-Container `rumahl-plugin-sandbox` läuft auf dem Host.
...
const SANDBOX_CONTAINER: &str = "rumahl-plugin-sandbox";
const SANDBOX_IMAGE: &str = "rumahl-plugin-sandbox:latest";
