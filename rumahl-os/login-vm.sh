...
os.write(fd, b'echo \"root:ora\" | chpasswd\n')
time.sleep(1)
...
time.sleep(3)
# Create ora user
os.write(fd, b'useradd -m -s /bin/bash -G sudo,docker ora 2>/dev/null; echo \"ora:ora\" | chpasswd\n')
time.sleep(1)
os.write(fd, b'mkdir -p /etc/ora && touch /etc/ora/ssh-ready\n')
