# ============================================================================
# qga.ps1 - rumahl Dev VM control over the QEMU Guest Agent (no IP needed)
# ============================================================================
...
#   .\qga.ps1 exec "systemctl status rumahl-home"
#   .\qga.ps1 exec "journalctl -u rumahl-home -n 30"
#   .\qga.ps1 read C:\...\.cache  -> prints /etc/ora/rumahl-home.env
#   .\qga.ps1 read /etc/ora/rumahl-home.env
