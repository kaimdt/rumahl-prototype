...
class DaemonManager {
    ...
    cliPath() {
        return vscode.workspace.getConfiguration('oraDev').get('cliPath') || 'rumahl-dev-deploy';
    }
    workspaceRoot() {
    ...
    bind() {
        return vscode.workspace.getConfiguration('oraDev').get('daemon.bind') || '127.0.0.1:8765';
    }
    autoStart() {
        return vscode.workspace.getConfiguration('oraDev').get('daemon.autoStart') ?? true;
    }
