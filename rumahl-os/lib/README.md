# rumahl Dev Libraries

Shared libraries for rumahl development automation scripts.

## Files

### `dev-auto-repair.sh`

Bash library providing intelligent auto-detection and auto-repair functions for rumahl dev VMs.

**Key Functions:**

- `detect_port_conflict(port)` — Check if port is in use and identify process
- `auto_resolve_port_conflict(port, service)` — Automatically free port or reuse existing rumahl VM
...
```powershell
# Import the module
Import-Module .\rumahl-os\lib\DevAutoRepair.psm1
