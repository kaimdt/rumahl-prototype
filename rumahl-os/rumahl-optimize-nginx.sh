#!/bin/bash
# ============================================================================
# rumahl-optimize-nginx.sh – Nginx Performance Optimization for rumahl OS
# ============================================================================
# Optimizes nginx configuration for better performance and lower latency.
#
# Usage: sudo ./rumahl-optimize-nginx.sh
# ============================================================================
...
# Must run as root
if [ "$(id -u)" -ne 0 ]; then
    echo "ERROR: Must run as root: sudo ./rumahl-optimize-nginx.sh"
    exit 1
fi
...
# rumahl OS Nginx Configuration (Optimized)
user www-data;
...
# rumahl OS Nginx Performance Tuning
