#!/usr/bin/env bash
# ============================================================================
# qga.sh – rumahl Dev VM control over the QEMU Guest Agent (no IP needed)
# ============================================================================
...
#   ./qga.sh exec 'systemctl status rumahl-home'
#   ./qga.sh exec 'journalctl -u rumahl-home -n 30'
#   ./qga.sh read  /etc/ora/rumahl-home.env # print a VM file
#   ./qga.sh write /tmp/test.txt 'hello'   # write a VM file (notfall sync)
#   ./qga.sh reboot                        # reboot the VM
#   ./qga.sh shutdown                      # power off the VM
#
# Socket: <repo>/rumahl-os/.cache/qga.sock (created by dev-local.sh).
