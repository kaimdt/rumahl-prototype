...
function New-rumahlRuntimeState {
...
function Read-rumahlRuntimeState {
    param([Parameter(Mandatory)][string]$Path)
    $state = New-rumahlRuntimeState -CachePath (Split-Path -Parent $Path)
...
function Save-rumahlRuntimeState {
...
function Update-rumahlRuntimeState {
...
function Clear-rumahlStaleRuntimeState {
    param([Parameter(Mandatory)]$State)
    if (Test-rumahlProcess -State $State) { return $State }
    $State.pid = $null
...
Export-ModuleMember -Function New-rumahlRuntimeState, Read-rumahlRuntimeState, Save-rumahlRuntimeState, Test-rumahlProcess, Get-rumahlConnection, Update-rumahlRuntimeState, Clear-rumahlStaleRuntimeState
