...
export const WIDGET_DEFINITIONS: WidgetDefinition[] = [
  ...
  // rumahl OS system widgets (Package 3 — Home Dashboard v2)
  { type: 'rumahl_storage', label: 'Speicher', icon: HardDrives, category: 'standalone', requiresEntity: false, defaultSize: { w: 2, h: 1 } },
  { type: 'rumahl_system', label: 'Serverzustand', icon: Cpu, category: 'standalone', requiresEntity: false, defaultSize: { w: 2, h: 1 } },
  { type: 'rumahl_jobs', label: 'Aktive Jobs', icon: ListBullets, category: 'standalone', requiresEntity: false, defaultSize: { w: 2, h: 2 } },
  { type: 'rumahl_recent_files', label: 'Letzte Dateien', icon: ClockCounterClockwise, category: 'standalone', requiresEntity: false, defaultSize: { w: 2, h: 2 } },
  { type: 'rumahl_presence', label: 'Anwesenheit', icon: Users, category: 'standalone', requiresEntity: false, defaultSize: { w: 2, h: 1 }, variants: [{ key: 'compact', label: 'Kompakt' }] },
  { type: 'rumahl_media', label: 'Medien', icon: FilmStrip, category: 'standalone', requiresEntity: false, defaultSize: { w: 2, h: 2 } },
