  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "rumahl-dialog data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[var(--layer-dialog)] flex flex-col gap-4  transition ease-in-out duration-[var(--dur-normal)]",
          side === "right" &&
