...
function SettingsSection({
  ...
  return (
    <div className="ora-card rounded-2xl overflow-hidden">
      <button
...
export function AppSettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-4 p-4 page-transition-enter">
      {/* Header */}
      <div className="ora-card rounded-2xl border border-foreground/[0.06] p-5">
...
function AppConfigSettings({ appId, token }: { appId: string; token: string }) {
  ...
  if (fields.length === 0) {
    return (
      <div className="ora-card rounded-2xl border border-foreground/[0.06] p-4">
