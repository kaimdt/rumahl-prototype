"""Number platform for rumahl Home Dashboard integration."""
...
async def async_setup_entry(
    ...
    """Set up rumahl Home Dashboard number entities."""
    entry_data = hass.data[DOMAIN][entry.entry_id]
    client = entry_data.get(DATA_CLIENT)
    coordinator = entry_data[DATA_COORDINATOR]

    async_add_entities([
        RumahlDashboardBrightnessNumber(coordinator, entry, client),
    ])


class RumahlDashboardBrightnessNumber(CoordinatorEntity, NumberEntity):
