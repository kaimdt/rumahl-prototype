"""Switch platform for rumahl Home Dashboard integration."""
...
async def async_setup_entry(
    ...
    """Set up rumahl Home Dashboard switches based on a config entry."""
    entry_data = hass.data[DOMAIN][entry.entry_id]
    client = entry_data.get(DATA_CLIENT)
    coordinator = entry_data[DATA_COORDINATOR]

    async_add_entities([
        RumahlDashboardSwitch(coordinator, entry, client, "screensaver", "Screensaver", "mdi:monitor-off"),
        RumahlDashboardSwitch(coordinator, entry, client, "auto_theme", "Auto Theme", "mdi:theme-light-dark"),
        RumahlDashboardSwitch(coordinator, entry, client, "webhooks", "Webhooks", "mdi:webhook"),
        RumahlDashboardSwitch(coordinator, entry, client, "sleep_mode", "Sleep Mode", "mdi:sleep"),
    ])


class RumahlDashboardSwitch(CoordinatorEntity, SwitchEntity):
