"""Sensor platform for rumahl Home Dashboard integration."""
...
async def async_setup_entry(
    ...
    """Set up rumahl Home Dashboard sensors based on a config entry."""
    coordinator = hass.data[DOMAIN][entry.entry_id][DATA_COORDINATOR]

    sensors = [
        RumahlDashboardConnectedClientsSensor(coordinator, entry),
        RumahlDashboardLastUpdateSensor(coordinator, entry),
        RumahlDashboardStateSensor(coordinator, entry),
        RumahlDashboardActiveThemeSensor(coordinator, entry),
        RumahlDashboardCurrentPageSensor(coordinator, entry),
        RumahlDashboardEntityCountSensor(coordinator, entry),
        RumahlDashboardVersionSensor(coordinator, entry),
        RumahlDashboardCacheHitsSensor(coordinator, entry),
        RumahlDashboardCacheMissesSensor(coordinator, entry),
        RumahlDashboardCacheUpdateTimeSensor(coordinator, entry),
        RumahlDashboardWSConnectedSensor(coordinator, entry),
        RumahlDashboardUptimeSensor(coordinator, entry),
        RumahlDashboardMemoryUsageSensor(coordinator, entry),
        RumahlDashboardActiveAutomationsSensor(coordinator, entry),
        RumahlDashboardErrorCountSensor(coordinator, entry),
        RumahlDashboardApiRequestsSensor(coordinator, entry),
        RumahlDashboardCacheSizeSensor(coordinator, entry),
        RumahlDashboardStateChangesTotalSensor(coordinator, entry),
        RumahlDashboardMostActiveEntitySensor(coordinator, entry),
        RumahlDashboardUnavailableEntitiesSensor(coordinator, entry),
        RumahlDashboardStaleEntitiesSensor(coordinator, entry),
        RumahlDashboardEntityHealthSensor(coordinator, entry),
        RumahlDashboardSmartScenesCountSensor(coordinator, entry),
        RumahlDashboardScheduledActionsCountSensor(coordinator, entry),
        RumahlDashboardWatchdogsCountSensor(coordinator, entry),
        RumahlDashboardWatchdogLastTriggeredSensor(coordinator, entry),
    ]

    async_add_entities(sensors)


class RumahlDashboardSensorBase(CoordinatorEntity, SensorEntity):
    """Base class for rumahl Dashboard sensors."""
...
class RumahlDashboardConnectedClientsSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardLastUpdateSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardStateSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardActiveThemeSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardCurrentPageSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardEntityCountSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardVersionSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardCacheHitsSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardCacheMissesSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardCacheUpdateTimeSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardWSConnectedSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardUptimeSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardMemoryUsageSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardActiveAutomationsSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardErrorCountSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardApiRequestsSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardCacheSizeSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardStateChangesTotalSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardMostActiveEntitySensor(RumahlDashboardSensorBase):
...
class RumahlDashboardUnavailableEntitiesSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardStaleEntitiesSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardEntityHealthSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardSmartScenesCountSensor(RumahlDashboardSensorBase):
    """Number of backend-powered smart scenes registered.

    Smart scenes are unique to rumahl Dashboard — they support sequenced
...
class RumahlDashboardScheduledActionsCountSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardWatchdogsCountSensor(RumahlDashboardSensorBase):
...
class RumahlDashboardWatchdogLastTriggeredSensor(RumahlDashboardSensorBase):
