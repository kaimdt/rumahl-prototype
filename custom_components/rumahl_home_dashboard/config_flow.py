"""Config flow for rumahl Home Dashboard integration."""
...
class MDTHomeDashboardConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for rumahl Home Dashboard."""
        ...
        if user_input is not None:
            ...
            if not errors:
                ...
                await self.async_set_unique_id(
                    dashboard_url or "rumahl_home_dashboard_default"
                )
...
class MDTHomeDashboardOptionsFlow(config_entries.OptionsFlow):
    """Handle options flow for rumahl Home Dashboard."""
