"""Binary sensor platform for rumahl Home Dashboard integration."""
...
async def async_setup_entry(
    ...
    """Set up rumahl Home Dashboard binary sensors based on a config entry."""
    ...
    async_add_entities([
        RumahlDashboardConnectionSensor(coordinator, entry),
        RumahlDashboardHAConnectedSensor(coordinator, entry),
    ])
...
class RumahlDashboardConnectionSensor(_BaseBinarySensor):
...
class RumahlDashboardHAConnectedSensor(_BaseBinarySensor):
