"""Constants for the rumahl Home Dashboard integration."""

DOMAIN = "rumahl_home_dashboard"
VERSION = "2.3.0"
...
# Defaults
DEFAULT_NAME = "rumahl Home Dashboard"
...
# -- Actionable device features (unique to rumahl Dashboard) --
