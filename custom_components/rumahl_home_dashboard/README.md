# rumahl Home Dashboard - Home Assistant Integration

[![hacs_badge](https://img.shields.io/badge/HACS-Custom-orange.svg)](https://github.com/custom-components/hacs)
[![GitHub Release](https://img.shields.io/github/release/rumahl/home-assistant-dashb.svg)](https://github.com/rumahl/home-assistant-dashb/releases)
[![License](https://img.shields.io/github/license/rumahl/home-assistant-dashb.svg)](LICENSE)

Die offizielle Home Assistant Custom Integration für das rumahl Home Dashboard. Diese Integration ermöglicht eine nahtlose Verbindung zwischen Home Assistant und dem rumahl Home Dashboard mit erweiterten Funktionen und bidirektionaler Kommunikation.
...
5. Fügen Sie diese URL hinzu: `https://github.com/rumahl/home-assistant-dashb`
6. Wählen Sie die Kategorie "Integration"
7. Klicken Sie auf "Hinzufügen"
8. Suchen Sie nach "rumahl Home Dashboard"
9. Klicken Sie auf "Download"
10. Starten Sie Home Assistant neu

### Manuelle Installation

1. Laden Sie die neueste Version von den [Releases](https://github.com/rumahl/home-assistant-dashb/releases) herunter
2. Entpacken Sie das Archiv
3. Kopieren Sie den Ordner `custom_components/rumahl_home_dashboard` in Ihr `custom_components` Verzeichnis
...
3. Suchen Sie nach **"rumahl Home Dashboard"**
...
### `sensor.rumahl_home_dashboard_connected_clients`
Anzahl der verbundenen Dashboard-Clients

### `sensor.rumahl_home_dashboard_last_update`
Zeitstempel der letzten Dashboard-Aktualisierung

### `sensor.rumahl_home_dashboard_dashboard_state`
...
### `rumahl_home_dashboard.refresh_state`
...
- [rumahl Home Dashboard Repository](https://github.com/rumahl/home-assistant-dashb)
- [Dashboard Dokumentation](https://github.com/rumahl/home-assistant-dashb/blob/main/README.md)
- [Issue Tracker](https://github.com/rumahl/home-assistant-dashb/issues)
- [Plugin Guide](https://github.com/rumahl/home-assistant-dashb/blob/main/PLUGIN_GUIDE.md)

## 🤝 Mitwirken

Beiträge sind willkommen! Bitte lesen Sie die [Contribution Guidelines](https://github.com/rumahl/home-assistant-dashb/blob/main/CONTRIBUTING.md).
