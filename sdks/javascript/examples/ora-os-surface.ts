 ...
 * Mirrors the example in docs/sdks/iora-sdk.md.
 *
 * Run: ts-node examples/ora-os-surface.ts (with IORA_APP_TOKEN set)
 */
import { IoraClient } from '../src';

const ora = new IoraClient({
  baseUrl: process.env.IORA_BASE_URL || 'http://localhost:8126',
