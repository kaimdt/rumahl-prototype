...
@dataclass
class HeartbeatMessage(IoraMessage):
...
@dataclass
class StatusUpdateMessage(IoraMessage):
...
@dataclass
class PermissionRequestMessage(IoraMessage):
...
@dataclass
class PermissionGrantMessage(IoraMessage):
...
@dataclass
class QueryMessage(IoraMessage):
...
@dataclass
class ResponseMessage(IoraMessage):
