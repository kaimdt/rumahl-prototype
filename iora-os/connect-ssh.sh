#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════
# connect-ssh.sh – SSH into the IORA dev VM
# ═══════════════════════════════════════════════════════════════════
# Usage: ./connect-ssh.sh [port] [user]
#   ./connect-ssh.sh              # root@127.0.0.1:2222
#   ./connect-ssh.sh 2222 iora    # iora@127.0.0.1:2222
# ═══════════════════════════════════════════════════════════════════

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
SSH_KEY="$SCRIPT_DIR/.cache/iora-dev-key"
PORT="${1:-2222}"
USER="${2:-root}"
...
echo -e "\033[0;36m[*]\033[0m Connecting to IORA Dev VM..."
echo "    User: $USER"
echo "    Port: $PORT"
echo "    Key:  $SSH_KEY"
echo ""
