...
export class Dashboard {
    ...
    constructor(private context: vscode.ExtensionContext, private getClient: () => DaemonClient | undefined) {}
    ...
    async refresh() {
        const c = this.getClient(); if (!c || !this.panel) return;
        try {
    ...
    private async onMsg(msg: any) {
      const c = this.getClient();
        switch (msg?.cmd) {
          ...
          case 'deployComponent': await vscode.commands.executeCommand('ioraDev.deployFromTree', { label: msg.component }); break;
          case 'watchComponent': await vscode.commands.executeCommand('ioraDev.watchFromTree', { label: msg.component }); break;
          case 'componentActions': await vscode.commands.executeCommand('ioraDev.componentActions', { label: msg.component }); break;
