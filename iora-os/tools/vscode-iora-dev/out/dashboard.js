...
class Dashboard {
    ...
    update(events) {
        if (!this.panel)
            return;
        const payload = { kind: 'event', payload: events };
    ...
    async onMsg(msg) {
        ...
        switch (msg?.cmd) {
            ...
            case 'deployComponent':
                await vscode.commands.executeCommand('ioraDev.deployFromTree', { name: msg.component });
                break;
            case 'watchComponent':
                await vscode.commands.executeCommand('ioraDev.watchFromTree', { name: msg.component });
                break;
            case 'stopWatch':
