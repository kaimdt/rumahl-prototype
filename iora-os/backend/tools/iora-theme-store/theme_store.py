#!/usr/bin/env python3
"""
IORA Theme Store – External Theme Repository Server
====================================================
Simple HTTP API for hosting, discovering, and serving IORA themes.
Run this on your server (e.g., themes.kaimdt.com) alongside the
main appstore.kaimdt.com.
...
def main():
    parser = argparse.ArgumentParser(description='IORA Theme Store Server')
