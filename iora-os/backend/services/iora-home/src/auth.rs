...
/// Format: mdt_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX (52 chars total)
...
mod tests {
    ...
    fn cleanup_test_secret() {
        std::env::remove_var("IORA_JWT_SECRET");
    }
    ...
    fn test_verify_token_wrong_secret() {
        ...
        std::env::set_var("IORA_JWT_SECRET", "different-secret-for-test");
    ...
    fn test_generate_api_key_format() {
        ...
        assert!(key.starts_with("mdt_"));
        assert_eq!(key.len(), 52); // "mdt_" + 48 hex chars (24 bytes encoded)
