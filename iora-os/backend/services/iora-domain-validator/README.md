...
The Domain Validator service enforces network access policies for IORA apps. It validates domain and IP access requests against app-specific whitelists, supporting wildcards, CIDR notation, and user-configurable additions.
...
- **iora-network-monitor** - Discovers devices on local network
- **iora-security** - Monitors for security threats
- **iora-appstore** - Loads app network policies from manifests
- **iora-nginx** - Routes validation requests to this service

## Further Reading

- [Network Access Control Documentation](../../docs/NETWORK_ACCESS_AND_DOCUMENTATION_SUMMARY.md)
- [App Manifest Schema](../iora-shared/src/app_manifest.rs)
