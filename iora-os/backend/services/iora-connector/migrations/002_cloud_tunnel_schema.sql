...
-- IORA Home connects OUTBOUND via WebSocket → relay proxies HTTP traffic

-- Tunnels: each IORA Home instance gets one tunnel
CREATE TABLE IF NOT EXISTS cloud_tunnels (
    id              TEXT PRIMARY KEY NOT NULL,
    name            TEXT NOT NULL DEFAULT 'IORA Home',
    description     TEXT,
...
-- Pairing tokens: one-time tokens to connect a new IORA instance
